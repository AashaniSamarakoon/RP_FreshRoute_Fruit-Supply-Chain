  ...
  en: {
    ...
    farmer: {
      ...
      cards: {
        ...
        predictionTitle: "Add Predict Harvest",
        predictionSubtitle: "Add a your harvest prediction",
    ...
    form: {
      ...
      expectedQuantity: "Expected Harvest Quantity",
      enterQuantity: "Enter quantity",
      grade: "Grade",
      estimatedHarvestDate: "Estimated harvest date",
  ...
  si: {
    ...
    farmer: {
      ...
      cards: {
        ...
        predictionTitle: "පුරෝකථන අස්වැන්න",
        predictionSubtitle: "ඔබේ පුරෝකථන අස්වැන්න එකතු කරන්න",
    ...
    form: {
      fruitType: "පළතුරු වර්ගය",
      selectFruit: "පළතුර තෝරන්න",
      category: "පළතුරු ප්‍රභේදය",
      selectCategory: "පළතුරු ප්‍රභේදය තෝරන්න",
      expectedQuantity: "අපේක්ෂිත අස්වැන්න ප්‍රමාණය",
      enterQuantity: "ප්‍රමාණය ඇතුළු කරන්න",
      grade: "ශ්‍රේණිය",
      estimatedHarvestDate: "අපේක්ෂිත අස්වැන්න දිනය",
