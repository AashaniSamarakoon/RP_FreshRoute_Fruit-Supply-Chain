...
export default function LocationStep() {
  ...
  const onNext = () => {
    ...
    if (role === "farmer") {
      updateFarmerData(payload);
      router.push("/onboarding/farmer/farm-info" as any);
    } else {
      // buyer or anything else treated as buyer
      updateBuyerData(payload);
      router.push("/onboarding/buyer/business" as any);
    }
  };
      ...
      <View style={styles.bottomCard}>
        ...
        >
          <Text style={styles.primaryButtonText}>
            {role === "farmer" ? "Next: Farm Details" : "Done"}
          </Text>
          <Ionicons
            name="arrow-forward"
            size={20}
