...
const mockData: FruitPrediction[] = [
  {
    ...
    emoji: "🥭",
    days: [
      { day: "Monday", trend: "up", trendText: "Price Demand", value: "600", unit: "units" },
      { day: "Tuesday", trend: "up", trendText: "Price Demand", value: "620", unit: "units" },
      { day: "Wednesday", trend: "down", trendText: "Slight Dip", value: "480", unit: "units" },
    ],
  },
  {
    name: "Pineapple",
    emoji: "🍍",
    days: [
      { day: "Monday", trend: "up", trendText: "Price Increase", value: "$2.50", unit: "kg" },
      { day: "Tuesday", trend: "stable", trendText: "Stable", value: "$2.55", unit: "kg" },
      { day: "Wednesday", trend: "down", trendText: "Dip", value: "$2.40", unit: "kg" },
    ],
  },
  {
    name: "Banana",
    emoji: "🍌",
    days: [
      { day: "Monday", trend: "stable", trendText: "Constant Demand", value: "1200", unit: "units" },
      { day: "Tuesday", trend: "up", trendText: "Rising Demand", value: "1250", unit: "units" },
      { day: "Wednesday", trend: "up", trendText: "Rising Demand", value: "1280", unit: "units" },
    ],
  },
];
      ...
      >
        {mockData.map((fruit, index) => (
          <TouchableOpacity 
            ...
            onPress={() => router.push(`/farmer/fruit-forecast?fruit=TJC ${fruit.name}`)}
          >
            {/* Fruit Header */}
