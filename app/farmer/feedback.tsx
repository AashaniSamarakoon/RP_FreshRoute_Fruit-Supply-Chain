...
export default function FeedbackScreen() {
  ...
  const [selectedTab, setSelectedTab] = React.useState<"Recent" | "Top" | "My Feedback">("Recent");
  const [feedbackText, setFeedbackText] = React.useState("");

  const filteredFeedbacks = mockFeedbacks.filter(f => f.category === selectedTab || selectedTab === "Recent");
            ...
            {filteredFeedbacks.map((feedback) => (
              <View key={feedback.id} style={styles.feedbackCard}>
                <View style={styles.feedbackHeader}>
                  <View style={styles.authorInfo}>
                    <View style={styles.authorAvatar}>
                      <Text style={styles.avatarText}>{feedback.author[0]}</Text>
                    </View>
                    <View>
                ...
                <View style={styles.feedbackActions}>
                  ...
                  <TouchableOpacity style={styles.actionButton}>
                    <Ionicons name="thumbs-down-outline" size={16} color="#ccc" />
